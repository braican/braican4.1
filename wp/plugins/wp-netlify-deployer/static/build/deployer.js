      ...
      _createClass(Deployer, [
          ...
          value: function init() {
            ...
            this.$trigger.on('click', function(event) {
              ...
              $.post(_this.ajaxurl, {
                ...
                .always(_this.completed.bind(_this))
                .done(function(resp) {
                  if (!resp.success) {
                    _this.error(resp);
                  } else {
        ...
        },
        {
          ...
          value: function success(msg) {
            ...
            var message = '<span class="deploy-message deploy-message--success">'.concat(
              msg,
              '</span>',
            );
            this.$trigger
              .after(message)
              .parent()
              .append('<p class="deploy-message--alert">'.concat(contextMessage, '</p>'));
